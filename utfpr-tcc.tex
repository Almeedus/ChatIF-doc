...
\include{estrutura/pre-textuais/folha-aprovacao} %ERRATA
\include{estrutura/pre-textuais/folha-aprovacao} %FOLHA-APROVAÇÃO
...
\include{estrutura/textuais/desenvolvimento/desenvolvimento}  			% Desenvolvimento
